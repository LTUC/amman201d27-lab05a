...
function multiplyArray(multArr) {
  let mArr1 = testArray[0]
  let mArr2 = testArray[1]
  let mArr3 = testArray[2]
  let x = multiply(mArr1,mArr2)[0]
  let y = multiply(x,mArr3)[0]
  // console.log(y);
  let multtxt = `The numbers ${testArray[0]},${testArray[1]},${testArray[2]} have a product of ${y}.`
  // console.log(multtxt);
  return[y,multtxt]
}
