...
Write a function called sumAndMultiply() that takes in three numbers as separate arguments and returns an array where the first element
 is the sum of those three numbers, the second element is the product of those three numbers, 
...
//function sumAndMultiply(a, b, c) {
  ...
  //let thirdElement=`the sum of ${a} and ${b} and ${c} is ${s}.`;
  //let fourthElemnt=`The product of ${a} and ${b} and ${c} is ${m}.`;
  //return [s,m,thirdElement,fourthElemnt];
//}
...
Write a function called sumArray() that takes in an array of numbers as its single argument and then returns an array where the
 first element is the sum of the numbers in the array, and the second element is a string that EXACTLY follows this example and uses the values that were
  input into the function:

"2,3,4 was passed in as an array of numbers, and 9 is their sum."

IMPORTANT DETAIL: You may not use the arithmetic operator + in this function. To do addition, use your sum() function that you've already created. You're going to 
have to be resourceful to figure out how to do this. However, you may continue to use the + operator for string concatenation.
...
function sumArray(sumArr) {
  ...
  let s1 =sum(s,sumArr[2])[0];
  let s2 =testArry +` was passed in as an array of numbers, and ${s1} is their sum.`;
  return [s1,s2];
}
...
Write a function called multiplyArray() that takes an array of numbers as its argument and returns an array whose first element is
 the product of those numbers, and the second element is a string that EXACTLY follows this example and uses the 
...
use your multiply() function that you've already created. You're going to have to be resourceful
 to figure out how to do this. This function should handle an array containing three elements. However, you
...
function multiplyArray(multArr) {
  let multiOfTOW = multiply(multArr[0]+multArr[1])[0];
  let multiOfThree=multiply(multiOfTOW,multArr[2])[0];
  let r=[The numbers ${multArr[0]},${multArr[1]},$[multArr[0]} have a product of multiOfThree.];
  return multiOfThree,r ;
}
