...
let sara = `The sum of ${a} and ${b} is ${c}.`
return [c,sara]
}
...
let c = a*b
  let sara = `The product of ${a} and ${b} is ${c}.`
return [c,sara]
}
...
let Mona = `${a} and ${b} and ${c} sum to ${d}.`
let Sami = `The product of ${a} and ${b} and ${c} is ${E}.`

return [d,E,Mona,Sami]
}
