...
function multiplyArray(multArr) {
  let multiArrAll = sumAndMultiply(multArr[0], multArr[1], multArr[2])[1]
  let strArr = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${multiArrAll}.`
  return [multiArrAll, strArr]
  //eslint-disable-line
}
