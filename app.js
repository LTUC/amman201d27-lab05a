...
Write a function called sumAndMultiply() that takes in three numbers as separate arguments and returns an
 ...
 three numbers,  and the third and fourth elements are strings that EXACTLY follow this example and use the values that were input into the function:
...
function sumArray(sumArr) {
  ...
  let a = sum((sumArr[0]), (sumArr[1]));
  a = a[0];
  let finalSum = sum(a, sumArr[2])[0];
  
  arr[0] = finalSum;


arr[1] = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${finalSum} is their sum.`
...
function multiplyArray(multArr) {
  ...
  let finalProduct = multiply(x, multArr[2]);
  finalProduct = finalProduct[0];
 multarr[0] = finalProduct;

 multarr[1] = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${finalProduct}.`
